...
public class SwapChars {
    ...
    public static void main(String[] s) {
        ...
        int minimunMoves = listChars.stream().map( charCount -> charCount.getOccurrences()/3).reduce(0, Integer::sum);
        System.out.println("minumum moves :" + minimunMoves);
    }
}
